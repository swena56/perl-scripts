...
#$template->process('dashboard/index.tpl', $template_vars,\$template_output)  || die $template->error();	
...
sub show_trends {
	...
	my $output = '';
	$template->process('dashboard/trends_popup.tpl', $vars,\$output)  || die $template->error();
...
sub update_dashboard {
	...
	my $output = '';
	$template->process('dashboard/index.tpl', $vars,\$output)  || die $template->error();
