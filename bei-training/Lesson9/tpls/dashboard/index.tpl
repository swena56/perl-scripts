...
$(document).ready(function(){
 ...
 <p> [% debug %] </p>
  ...
  <div class="panel-body">            
            <div class="col-md-4">
[% INCLUDE dashboard/top10/calltypes_by_totalcalls.tpl rendering_info = top_ten_calltypes(dashboard_data.month_index) %]
            <div id="draw_top_ten_models_here"></div>
            </div>
            <div class="col-md-4">
[% INCLUDE dashboard/top10/models_by_totalcalls.tpl rendering_info = top_ten_models(dashboard_data.month_index) %]
            </div>
            <div class="col-md-4">
 [% INCLUDE dashboard/top10/techs_by_totalcalls.tpl rendering_info = top_ten_techs(dashboard_data.month_index) %] 
            </div>
            </div>
  </div>
...
<button type="button" class="btn btn-info" data-toggle="collapse" data-target="#total_parts">Total Parts: [% dashboard_data.total_parts %]</button> 
  ...
  <div class="panel-body">
      <div class="col-md-3"> 
        [% INCLUDE dashboard/top10/calltypes_by_partscost.tpl rendering_info = calltypes_by_partscost(dashboard_data.month_index) %] 
      </div>
      <div class="col-md-3"> 
        [% INCLUDE dashboard/top10/parts_by_partscost.tpl rendering_info = parts_by_partscost(dashboard_data.month_index) %]    
      </div>
      <div class="col-md-3">           
        [% INCLUDE dashboard/top10/models_by_partscost.tpl rendering_info = models_by_partscost(dashboard_data.month_index) %] 
      </div>
       <div class="col-md-3">           
       [% INCLUDE dashboard/top10/techs_by_partscost.tpl rendering_info = techs_by_partscost(dashboard_data.month_index) %] 
      </div>
  </div>
  </div>
</div>
