...
<script>  
    ...
    function draw_parts_button(service_id){

           $("#draw_popup_here").empty();


           $("#draw_popup_here").append($("<h3> "+ service_id +" </h3>"));
           //var model = $("#popup_model");
           //model.append($("<h3> "+ service_id +" </h3>"));
      ...
      $.post('search/serial_json.cgi', {
        ...
        direction: direction}, function(json) {
            ...
            json.result_data.forEach(function(row) {
                ...
                row_data.append($("<td><a href='javascript:draw_parts_button("+row.service_id+")'>" + (total_parts_cost) + "</a> </td>"));  
